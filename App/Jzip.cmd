...
if not defined UIRatio set "UIRatio=m"
...
for %%Z in (
	chs/936/1/n/0x30/""/0x0e0000/0x100000/0x120000
	chs/936/2/y/0x36/"黑体"/0x0e0000/0x100000/0x120000
	en/437/1/y/0x30/""/0x0d0007/0x140008/0x140008
...
>nul 2>nul (reg query "HKLM\System\CurrentControlSet\Control\Session Manager\Environment" /v PROCESSOR_ARCHITECTURE | find /i "AMD64") && (
	set "path.editor.7z=%dir.jzip%\Bin\x64\7z.exe"
	set "path.editor.rar=%dir.jzip%\Bin\x64\Rar.exe"
)
>nul 2>nul (reg query "HKLM\System\CurrentControlSet\Control\Session Manager\Environment" /v PROCESSOR_ARCHITECTURE | find /i "ARM64") && (
